...
CAPABILITIES = {
    ...
    "流水线/流程/编排": {
        "triggers": ["流水线", "流程", "编排", "状态图", "节点", "审查意见", "oa答复", "长链路"],
        "sages": ["徐骋", "陈彤", "陈方移"],
    },
    "跨界/集成/场景": {
    ...
    "流体闭环/传感执行": {
        "triggers": ["流体", "闭环", "传感器", "执行器", "卫浴", "水质", "管路", "密封", "回路"],
        "sages": ["江漪", "黄嵩泉"],
    },
    "接口契约/前后端对接": {
        "triggers": ["接口", "协议", "契约", "前端", "网页", "事件流", "对接", "入口", "交互"],
        "sages": ["金辰宇", "徐骋"],
    },
    "生物医药/生命工艺": {
        "triggers": ["生物", "生命", "医药", "制药", "基因", "酶", "发酵", "医疗", "生物工艺"],
        "sages": ["钱文宇", "陈哲锋"],
    },
    "材料化工/配方放大": {
        "triggers": ["材料", "化工", "锂电", "高分子", "配方", "组分", "复合", "反应釜"],
        "sages": ["陈哲锋", "钱文宇"],
    },
}
